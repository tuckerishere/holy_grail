package com.secretcow.holygrail.utilities;
...
public class JwtUtility {
    ...
    public String generate(String username, Integer totalTimeInMS) {
        return Jwts.builder()
                .subject(username)
                .issuedAt(new Date(System.currentTimeMillis()))
                .expiration(new Date(System.currentTimeMillis() + totalTimeInMS))
                .signWith(secretKey)
                .compact();
    }
